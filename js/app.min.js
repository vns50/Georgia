...
const slidersWhoSlider = new Swiper('.sliders-who__slider', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 20,
	...
	pagination: {
		el: '.slider-who__controls',
		clickable: true,
	},

});
const whoSliderSkills = new Swiper('.who__slider-skills', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 20,
	...
	/*
		pagination: {
			el: '..who-slider__controls',
			clickable: true,
		},
	*/
});

slidersWhoSlider.controller.control = whoSliderSkills;
whoSliderSkills.controller.control = slidersWhoSlider;


/*
let whoColumn = new Swiper('.who__column', {
	observer: true,
	observeParents: true,
	//slidesPerView: 1,
	spaceBetween: 0,
...
//menu
/*
let var1 = document.querySelector('.');
let var2 = document.querySelector('.');
